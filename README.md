...
|----------------|-------------|
| [smart-contract-analyzer](.claude/skills/smart-contract-analyzer/) | Parallel security audit across [33 specialized subagents](.claude/agents/), each one responsible for different groups of attack vectors |
